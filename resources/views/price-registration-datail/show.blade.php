        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">PriceRegistrationDatail {{ $priceregistrationdatail->id }}</div>
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/price-registration-datail/' . $priceregistrationdatail->id . '/edit') }}" title="Edit PriceRegistrationDatail"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
