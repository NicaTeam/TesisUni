<customerordercreate :companies="{{ $companies }}" :cigars="{{ $cigars }}" :prices="{{ $prices }}" id="orderComponent" inline-template>
    ...
    <div>
                    ...
                    <div class="form-group {{ $errors->has('company_id') ? 'has-error' : ''}}">
                        <label for="company_id" class="col-md-4 control-label">{{ 'Customer' }}</label>
                            ...
                            <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
                                    ...
                                    <select v-on:change="buscarCompany" v-model="company_id" name="company_id" id="company_id" class="form-control">
       ...
       <div class="form-group {{ $errors->has('reference') ? 'has-error' : ''}}">
        ...
        <div class="form-group {{ $errors->has('company_name') ? 'has-error' : ''}}">
            <label for="company_name" class="col-md-4 control-label">{{ 'Customer name' }}</label>
        ...
        <div class="form-group {{ $errors->has('company_shipping_addres') ? 'has-error' : ''}}">
            <label for="company_shipping_addres" class="col-md-4 control-label">{{ 'Customer shipping address' }}</label>
        ...
        <div class="form-group {{ $errors->has('company_contact_name') ? 'has-error' : ''}}">
            <label for="company_contact_name" class="col-md-4 control-label">{{ 'Customer´s contact' }}</label>
        ...
        <div class="form-group {{ $errors->has('company_contact_email') ? 'has-error' : ''}}">
            <label for="company_contact_email" class="col-md-4 control-label">{{ 'Customers contact´s email' }}</label>
            <div v-for="persons in selectedCliente" class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('payment_term_name') ? 'has-error' : ''}}">
            <label for="payment_term_name" class="col-md-4 control-label">{{ 'Payment term' }}</label>
        ...
        <div class="form-group {{ $errors->has('customs_agency_name') ? 'has-error' : ''}}">
            <label for="customs_agency_name" class="col-md-4 control-label">{{ 'Custom agent' }}</label>
        ...
        <div class="form-group {{ $errors->has('customs_agency_shipping_address') ? 'has-error' : ''}}">
            <label for="customs_agency_shipping_address" class="col-md-4 control-label">{{ 'Custom agent address' }}</label>
            <div v-for="agents in selectedCliente" class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('customs_agency_contact_email') ? 'has-error' : ''}}">
            <label for="customs_agency_contact_email" class="col-md-4 control-label">{{ 'Customs agent email' }}</label>
            <div v-for="agents in selectedCliente"  class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <label for="cigar_id" class="col-md-4 control-label">{{ 'Brand and presentation' }}</label>
                            ...
                            <div class="form-group {{ $errors->has('brand_name') ? 'has-error' : ''}}">
                                <label for="brand_name" class="col-md-4 control-label">{{ 'Line or brand' }}</label>
                            ...
                            <div class="form-group {{ $errors->has('cigar_name') ? 'has-error' : ''}}">
                                <label for="cigar_name" class="col-md-4 control-label">{{ 'Name of the cigar' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('cigar_barcode') ? 'has-error' : ''}}">
                                <label for="cigar_barcode" class="col-md-4 control-label">{{ 'Barcode' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('cigar_unitOfMeasurement_name') ? 'has-error' : ''}}">
                                <label for="cigar_unitOfMeasurement_name" class="col-md-4 control-label">{{ 'Unit of measurement' }}</label>
                            ...
                            <div class="form-group {{ $errors->has('cigar_unitOfMeasurement_name') ? 'has-error' : ''}}">
                                <label for="cigar_unitsInPresentation" class="col-md-4 control-label">{{ 'Units in presentation' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('cigar_netWeight') ? 'has-error' : ''}}">
                                <label for="cigar_netWeight" class="col-md-4 control-label">{{ 'Net Weight' }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                    ...
                                    <input class="btn btn-primary" type="button" v-on:click="agregrarProd" id="bt_add" value="Add">
        ...
        <div class="form-group {{ $errors->has('total_net_weight_in_grams') ? 'has-error' : ''}}">
            <label for="total_net_weight_in_grams" class="col-md-4 control-label">{{ 'Total net weight in grams' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('total_boxes') ? 'has-error' : ''}}">
            <label for="total_boxes" class="col-md-4 control-label">{{ 'Total boxes' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('total_packs') ? 'has-error' : ''}}">
            <label for="total_packs" class="col-md-4 control-label">{{ 'Total packs' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('total_cigars') ? 'has-error' : ''}}">
            <label for="total_cigars" class="col-md-4 control-label">{{ 'Total cigars' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('amount_order_total') ? 'has-error' : ''}}">
            <label for="amount_order_total" class="col-md-4 control-label">{{ 'Total order' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('shipping_quote') ? 'has-error' : ''}}">
            <label for="shipping_quote" class="col-md-4 control-label">{{ 'Shipping quote' }}</label>
            <div class="col-md-6">
                <input class="form-control redondeado confondo" name="shipping_quote" type="number" id="shipping_quote" v-model="shipping_quote" readonly>
                {!! $errors->first('amount_order_total', '<p class="help-block">:message</p>') !!}
            </div>
        </div>

        <div class="form-group {{ $errors->has('final_freight_cost') ? 'has-error' : ''}}">
            <label for="final_freight_cost" class="col-md-4 control-label">{{ 'Final shipping cost' }}</label>
            <div class="col-md-6">
                <input class="form-control redondeado confondo" name="final_freight_cost" type="number" id="final_freight_cost" v-model="final_freight_cost" readonly>
                {!! $errors->first('amount_order_total', '<p class="help-block">:message</p>') !!}
            </div>
        </div>

        <div class="form-group {{ $errors->has('amount_due') ? 'has-error' : ''}}">
            <label for="amount_due" class="col-md-4 control-label">{{ 'Due amount' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('raw_order_file') ? 'has-error' : ''}}">
            <label for="raw_order_file" class="col-md-4 control-label">{{ 'File' }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group">
            <div class="col-md-offset-4 col-md-4">
                <input class="btn btn-primary" type="submit" value="{{ $submitButtonText or 'Save' }}">
            </div>
        </div>
