            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/customs-agency') }}" title="Back">
                            <button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Atras</button>
                        </a>

                        <a href="{{ url('/customs-agency/' . $customsAgency->id . '/edit') }}" title="Edit CustomsAgency">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                <tr>
                                    <th>#</th><th>Nombre</th><th>Apellidos</th><th>Titulo</th><th>Email</th><th>Telefono</th><th>Opciones</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($customsAgency->persons as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/person/' . $item->id) }}" title="Ver contacto">
                                                <button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button>
                                            </a>

                                            <a href="{{ url('/person/' . $item->id . '/edit') }}" title="Edit Person">
