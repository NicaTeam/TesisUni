            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/employee/' . $employee->id . '/edit') }}" title="Edit Employee"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $employee->name }} </td></tr><tr><th> LastName </th><td> {{ $employee->lastName }} </td></tr><tr><th> Email </th><td> {{ $employee->email }} </td></tr>
                                </tbody>
                            </table>
                        </div>
