<div class="form-group {{ $errors->has('Name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="lastName" type="text" id="lastName" value="{{ $usuario->lastName or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="phone_Number" type="text" id="phone_Number" value="{{ $usuario->phone_Number or ''}}" >
