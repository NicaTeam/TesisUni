<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="name" type="text" id="name" value="{{ $company->name or ''}}" >
...
<div class="form-group {{ $errors->has('countries_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        ...
        {{----}}
        {!! Form::select('countries_id', $countries, $selectedCountry, ['class' =>'form-control']) !!}
    </div>
</div><div class="form-group {{ $errors->has('company_types_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        ...
        {{----}}
        {!! Form::select('company_types_id', $company_type, $selectedCompanyType, ['class' => 'form-control']) !!}
    </div>
</div>
